    ...
    <body>
        ...
        <section id="Collection">
            ...
            <div id="ceiling-fan">
                ...
                <br>
                <a href="../../../HanyaKipas/Homepage/Intro/cellingfan.php">View More >></a>
            </div>
            <div id="table-fan">
                <img src="tablefan.png" alt="tablefan"></img>
                <p>Feel a Greater Breeze Experience</p>
                <br>
                <a href="../../../HanyaKipas/Homepage/Intro/tablefan.php">View More >></a>
            </div>
            <div id="bladeless-fan">
                <img src="bladelessfan.png" alt="bladelessfan"></img>
                <p>Cool Comfort, No Blades Attached </p>
                <br>
                <a href="../../../HanyaKipas/Homepage/Intro/bladelessfan.php">View More >></a>
            </div>
        </section>
        <br>
        <br>
